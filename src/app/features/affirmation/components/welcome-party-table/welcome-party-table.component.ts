...
import { NewWelcomePartyComponent } from '../new-welcome-party/new-welcome-party.component';
import { ConfirmDialogModule } from 'primeng/confirmdialog';
import { LoadingService } from '../../../../core/services/loading.service';

@Component({
  selector: 'app-welcome-party-table',
  imports: [
    CommonModule,
    TableModule,
    FormsModule,
  ...
  templateUrl: './welcome-party-table.component.html',
  styleUrl: './welcome-party-table.component.scss'
})
export class WelcomePartyTableComponent {
    ...
    onDeleteActivity(affirmation: any) {
      this._confirmationService.confirm({
        ...
        message: '¿Seguro que deseas eliminar este evento de fiesta de bienvenida?',
    ...
    getAffirmationPaginations() {
      ...
      this._affirmationService
        .getAllPaginations(this.paginationParams, 1)
    ...
    ///NewWelcomePartyComponent
    openAddParty() {
          this.ref = this._dialogService.open(NewWelcomePartyComponent, {
            contentStyle: {
              'max-width': '400px',
              'min-width': '400px',
              overflow: 'auto',
