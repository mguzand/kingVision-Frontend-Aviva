...
@Component({
  selector: 'app-and-participant-health-server',
  imports: [
    InputMaskModule,
    InputTextModule,
    CommonModule,
  ...
  templateUrl: './and-participant-health-server.component.html',
  styleUrl: './and-participant-health-server.component.scss'
})
export class AndParticipantHealthServerComponent {
  ...
  onSubmit(){
    ...
    this._affirmationService.addParticipantsHealth(this.form.value)
    .pipe(
        finalize(() => {
